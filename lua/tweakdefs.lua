...
local function getRaptorTier(name)
    ...
    if name:match("apex") or name:match("behemoth") or name:match("leviathan") then
        return 4
    end
    -- T3: assault / overseer / advanced variants
    if name:match("assault") or name:match("overseer") or name:match("advanced")
       or name:match("stalker") or name:match("demolisher") then
        return 3
    end
    -- T2: warrior / hunter / mid-tier
    if name:match("warrior") or name:match("hunter") or name:match("raider")
